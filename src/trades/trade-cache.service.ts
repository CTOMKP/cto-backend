...
export class TradeCacheService {
  ...
  private readonly defaultTtlSeconds = Number(process.env.TRADES_CACHE_TTL_SECONDS || 2592000);
  private readonly staleTtlSeconds = Number(process.env.TRADES_CACHE_STALE_TTL_SECONDS || 5184000);
  private hits = 0;
  private misses = 0;
  private staleHits = 0;
