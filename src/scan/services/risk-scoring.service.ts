...
export interface TierCriteria {
  ...
  wallet_activity: {
    min_active_wallets?: number;
    max_active_wallets?: number;
    flag_if_over?: {
      active_wallets?: number;
      sell_off_percent?: number;
      affected_wallets_percent?: number;
    };
    flag_if_sell_off?: {
      sell_off_percent?: number;
    };
    max_wallet_supply_percent?: number;
  };
}
...
export interface Tier {
  weighting: TierWeighting;
  risk_score_target: number;
