...
@Module({
  ...
  providers: [ListingService, ListingRepository, CacheService, RefreshWorker, RateLimiterGuard, MetricsService, ListingGateway],
  exports: [ListingService, MetricsService, ListingGateway],
})
